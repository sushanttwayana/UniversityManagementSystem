...
<body>
    <div class="container">
        ...
        <form action="datainsert2.php" method="POST">
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number"  name="no" placeholder="Enter mobile number" required>
                        </div>
                        ...
                        <div class="input-field">
                            ...
                            <input type="number"  name="s_id" placeholder="Enter the ID" required>
                        </div>
